...
export const handleGetExaminationTypes = (
  dispatch: Dispatch<GetExaminationTypes>
) => {
...
export const handleGetExaminationTypesFail = (
  dispatch: Dispatch<GetExaminationTypesFail>
) => {
  dispatch({
    type: ExaminationTypesActionTypes.GET_EXAMINATION_TYPES_FAIL,
  })
...
export const getExaminationTypesByPetId = (
  petId: string
...
export const handleGetExaminationTypesByPetId = (
  dispatch: Dispatch<GetExaminationTypes>
) => {
  dispatch({ type: ExaminationTypesActionTypes.GET_EXAMINATION_TYPES })
}
...
export const handleGetExaminationTypesByPetIdFail = (
  dispatch: Dispatch<GetExaminationTypesByPetIdFail>
) => {
  dispatch({
    type: ExaminationTypesActionTypes.GET_EXAMINATION_TYPES_BY_PET_ID_FAIL,
  })
...
export const getExaminationType = (
  ...
  try {
    const response: ExaminationType = await examinationTypes.getExaminationType(
      id
    )
...
export const handleGetExaminationType = (
  dispatch: Dispatch<GetExaminationType>
) => {
...
const handleGetExaminationTypeFail = (
  dispatch: Dispatch<GetExaminationTypeFail>
) => {
  dispatch({
    type: ExaminationTypesActionTypes.GET_EXAMINATION_TYPE_FAIL,
  })
...
export const createExaminationType = (
  examinationType: ExaminationType
): ThunkResult<void> => async dispatch => {
  handleCreateExaminationType(dispatch)
  try {
    const response: ExaminationType = await examinationTypes.create(
      examinationType
    )
    handleCreateExaminationTypeSuccess(dispatch, response)
    toast.success('Pomyślnie utworzono typ badania')
  } catch (e) {
    handleCreateExaminationTypeFail(dispatch)
  }
}

const handleCreateExaminationType = (
  dispatch: Dispatch<CreateExaminationType>
) => {
...
const handleCreateExaminationTypeFail = (
  dispatch: Dispatch<CreateExaminationTypeFail>
) => {
...
export const updateExaminationType = (
  ...
  try {
    const response: ExaminationType = await examinationTypes.update(
      updatedExaminationType
    )
    handleUpdateExaminationTypeSuccess(dispatch, response)
    toast.success('Pomyślnie zaktualizowano typ badania')
  } catch (e) {
    handleUpdateExaminationTypeFail(dispatch)
  }
}

const handleUpdateExaminationType = (
  dispatch: Dispatch<UpdateExaminationType>
): void => {
...
const handleUpdateExaminationTypeSuccess = (
  ...
  dispatch({
    type: ExaminationTypesActionTypes.UPDATE_EXAMINATION_TYPE_SUCCESS,
    payload: updatedExaminationType,
  })
}

const handleUpdateExaminationTypeFail = (
  dispatch: Dispatch<UpdateExaminationTypeFail>
) => {
...
export const deleteExaminationType = (
  ...
  try {
    ...
    toast.success('Pomyślnie usunięto typ badania')
  } catch (e) {
