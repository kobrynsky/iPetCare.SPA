...
export const handleGetExaminationParameters = (
  dispatch: Dispatch<GetExaminationParameters>
) => {
  dispatch({
    type: ExaminationParametersActionParameters.GET_EXAMINATION_PARAMETERS,
  })
...
export const handleGetExaminationParametersSuccess = (
  ...
  dispatch({
    type:
      ExaminationParametersActionParameters.GET_EXAMINATION_PARAMETERS_SUCCESS,
    payload: response,
  })
}

export const handleGetExaminationParametersFail = (
  dispatch: Dispatch<GetExaminationParametersFail>
) => {
  dispatch({
    type: ExaminationParametersActionParameters.GET_EXAMINATION_PARAMETERS_FAIL,
  })
...
export const getExaminationParameter = (
  id: number
): ThunkResult<void> => async dispatch => {
  handleGetExaminationParameter(dispatch)
  try {
    const response: ExaminationParameter = await examinationParameters.getExaminationParameter(
      id
    )
...
export const handleGetExaminationParameter = (
  dispatch: Dispatch<GetExaminationParameter>
) => {
  dispatch({
    type: ExaminationParametersActionParameters.GET_EXAMINATION_PARAMETER,
  })
...
const handleGetExaminationParametersuccess = (
  ...
  dispatch({
    type:
      ExaminationParametersActionParameters.GET_EXAMINATION_PARAMETER_SUCCESS,
    payload: response,
  })
}

const handleGetExaminationParameterFail = (
  dispatch: Dispatch<GetExaminationParameterFail>
) => {
  dispatch({
    type: ExaminationParametersActionParameters.GET_EXAMINATION_PARAMETER_FAIL,
  })
...
export const createExaminationParameter = (
  examinationParameter: ExaminationParameter
): ThunkResult<void> => async dispatch => {
  handleCreateExaminationParameter(dispatch)
  try {
    const response: ExaminationParameter = await examinationParameters.create(
      examinationParameter
    )
    handleCreateExaminationParameterSuccess(dispatch, response)
    toast.success('Pomyślnie utworzono parametr badania')
  } catch (e) {
    handleCreateExaminationParameterFail(dispatch)
  }
}

const handleCreateExaminationParameter = (
  dispatch: Dispatch<CreateExaminationParameter>
) => {
  dispatch({
    type: ExaminationParametersActionParameters.CREATE_EXAMINATION_PARAMETER,
  })
...
const handleCreateExaminationParameterSuccess = (
  ...
  dispatch({
    type:
      ExaminationParametersActionParameters.CREATE_EXAMINATION_PARAMETER_SUCCESS,
    payload: response,
  })
  history.push('/ExaminationParameters')
}

const handleCreateExaminationParameterFail = (
  dispatch: Dispatch<CreateExaminationParameterFail>
) => {
  dispatch({
    type:
      ExaminationParametersActionParameters.CREATE_EXAMINATION_PARAMETER_FAIL,
  })
}
...
export const updateExaminationParameter = (
  ...
  try {
    const response: ExaminationParameter = await examinationParameters.update(
      updatedExaminationParameter
    )
    handleUpdateExaminationParameterSuccess(dispatch, response)
    toast.success('Pomyślnie zaktualizowano paramter badania')
  } catch (e) {
    handleUpdateExaminationParameterFail(dispatch)
  }
}

const handleUpdateExaminationParameter = (
  dispatch: Dispatch<UpdateExaminationParameter>
): void => {
  dispatch({
    type: ExaminationParametersActionParameters.UPDATE_EXAMINATION_PARAMETER,
  })
...
const handleUpdateExaminationParameterSuccess = (
  ...
  dispatch({
    type:
      ExaminationParametersActionParameters.UPDATE_EXAMINATION_PARAMETER_SUCCESS,
    payload: updatedExaminationParameter,
  })
}

const handleUpdateExaminationParameterFail = (
  dispatch: Dispatch<UpdateExaminationParameterFail>
) => {
  dispatch({
    type:
      ExaminationParametersActionParameters.UPDATE_EXAMINATION_PARAMETER_FAIL,
  })
}
...
export const deleteExaminationParameter = (
  ...
  try {
    ...
    dispatch({
      type:
        ExaminationParametersActionParameters.DELETE_EXAMINATION_PARAMETER_SUCCESS,
      payload: deletedId,
    })
    toast.success('Pomyślnie usunięto parametr badania')
  } catch (e) {
    dispatch({
      type:
        ExaminationParametersActionParameters.DELETE_EXAMINATION_PARAMETER_FAIL,
    })
  }
}
