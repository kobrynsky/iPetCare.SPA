...
import { Card, Typography, Grid, CircularProgress, CardContent, TableContainer, Paper, Table, TableHead, TableRow, TableCell, TableBody, makeStyles, Box } from "@material-ui/core"
...
export const PetExaminationPage = (props: RouteComponentProps<PetExaminationPageParams>) => {
    ...
    return (
        examinationsState.loading ?
            ...
            <div>
                <Box marginY={2}>
                    <Typography variant="h2" className="title">Szczegóły badania</Typography>
                </Box>
                <Grid
                    container
                    direction="row"
                                    ...
                                    {examination?.examinationParameterValues.map((param) =>
                                        <TableRow key={param.id}>
                                            ...
                                            <TableCell align="center">
                                                {param.value >= param.examinationParameter.lowerLimit && param.value <= param.examinationParameter.upperLimit
                                                    ?
                                            ...
                                            <TableCell align="center">
                                                {param.examinationParameter.lowerLimit}-{param.examinationParameter.upperLimit}
                                            </TableCell>
                                        </TableRow>
                                    )}
                                </TableBody>
