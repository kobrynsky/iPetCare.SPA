...
import { getPets, getMyPets, deletePet, createPet, updatePet } from '../../../state/pets/petsActions'
                        ...
                        columns={[
                            {
                                title: 'Nazwa',
                                field: 'name',
                                render: row => (<Link to={`/pets/details/${row.id}`}>{row.name}</Link>)
                            },
                            ...
                            },
                            {
                                title: 'Rasa',
                                field: 'raceId',
                                lookup: racesState.items.reduce((a, x) => ({ ...a, [x.id as number]: x.name }), {})
                            },
                            {
